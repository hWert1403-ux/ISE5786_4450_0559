...
class CameraTests {
	...
	void testBuild() {
		...
		Builder builderBV03 = Camera.getBuilder().setLocation(LOCATION).setDirection(V_TO, V_UP)
		...
		Builder builderBV09 = Camera.getBuilder().setLocation(LOCATION).setDirection(V_TO, V_UP).setVpDistance(0)
				.setVpSize(8, 8);
		...
		Builder builderBV10 = Camera.getBuilder().setLocation(LOCATION).setDirection(V_TO, V_UP).setVpDistance(-1)
				.setVpSize(8, 8);
	 ...
	 * <p>
	 * Verifies ray construction through representative pixels in 3x3 and 4x4 view
	 * planes, including all three direction-setting overloads.
	 * </p>
	 */
	@Test
	void testConstructRay() {
		...
		Camera camera4x4ByTargetAndUp = baseBuilder().setVpSize(8, 8).setResolution(4, 4).setDirection(TARGET, V_UP)
				.build();
