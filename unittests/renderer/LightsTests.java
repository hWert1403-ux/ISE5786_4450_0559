...
class LightsTests {
	...
	private final Scene _scene2 = new Scene("Test scene").setAmbientLight(new AmbientLight(new Color(38, 38, 38)));
	...
	/** The first triangle in appropriate tests */
	private static final Geometry TRIANGLE2 = new Triangle(VERTICES[0], VERTICES[1], VERTICES[3]).setMaterial(MATERIAL);
