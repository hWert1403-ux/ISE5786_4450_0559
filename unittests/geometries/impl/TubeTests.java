...
/**
 * Unit tests for class {@link geometries.impl.Tube}. The tests verify normal
 * calculation for tubes in 3D space. Tests follow the methodology of
...
class TubeTests {
	...
	void testGetNormal() {
		// Arrange
		Tube tube = new Tube(RADIUS, AXIS_RAY);

		// ============ Equivalence Partitions Tests ==============

		// TC01: Point on the surface "in front of" the ray head (positive projection on
		// axis)
		...
		// TC02: Point on the surface "behind" the ray head (negative projection on
		// axis)
		...
		// TC11: Point on the surface directly across from the ray head (projection is
		// zero)
		Point pHead = V1;
