...
/**
 * Class Vector represents a vector in 3D space, defined by its direction and
 * length. The class inherits from Point and represents the vector from the
 * origin (0,0,0) to the point (x,y,z). *
 * <p>
 * Note: A vector cannot be the zero vector (0,0,0).
 * </p>
 * * @author hadas&shani
 */
public final class Vector extends Point {
	/** Unit vector on the X axis (1,0,0) */
    public static final Vector AXIS_X = new Vector(1, 0, 0);

    /** Unit vector on the Y axis (0,1,0) */
    public static final Vector AXIS_Y = new Vector(0, 1, 0);

    /** Unit vector on the Z axis (0,0,1) */
    public static final Vector AXIS_Z = new Vector(0, 0, 1);
	
	/**
	 * Constructor to initialize a Vector with three double coordinates. * @param x
	...
	/**
	 * Constructor to initialize a Vector with a Double3 object. * @param xyz
	...
	/**
	 * Adds another vector to this vector using vector addition. * @param vector the
	 * vector to add
	 * 
	...
	/**
	 * Calculates the cross product (vector product) between this vector and
	 * another. * @param other
	 * 
	 * @return a new Vector orthogonal to both input vectors
	 * @throws IllegalArgumentException if the vectors are parallel (cross product
	 *                                  is zero)
	 */
	...
	/**
	 * Calculates the actual length of the vector. * @return the length of the
	 * vector
	 */
	...
	/**
	 * Normalizes the vector so its length will be 1. * @return a new normalized
