 ...
 * floating-point comparisons in rendering calculations and tests. Because
 * equality is approximate, this class is not well-suited for use as a key in
 * hash-based collections that rely on strict equality semantics.
 * 
...
public final class Color {
	 ...
	 * <p>
	 * Each component must be non-negative. Values greater than 255 are allowed and
	 * may be useful for representing light intensities.
	 * 
	...
	/**
	 * Tolerant equality based on {@code DELTA} per RGB component. Intended for
	 * floating-point comparisons in rendering and tests.
	 * <p>
	 * Note: This is approximate equality (not strictly transitive) and is not
	 * suitable for use in hash-based collections.
	 * 
	 * @param obj the object to compare with
	 * @return <b>{@code true}</b> if the given object is a {@code Color} whose RGB
	 *         components differ from this color by less than {@code DELTA};
	 *         <b>{@code false}</b> otherwise
	 */
	@Override
	public boolean equals(Object obj) {
		return this == obj || (obj instanceof Color other && abs(_rgb._d1() - other._rgb._d1()) < DELTA
				&& abs(_rgb._d2() - other._rgb._d2()) < DELTA && abs(_rgb._d3() - other._rgb._d3()) < DELTA);
	}
	 ...
	 * @return {@code true} if all given colors are approximately equal to this
	 *         color (vacuously {@code true} if no colors are provided);
